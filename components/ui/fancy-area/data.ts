...
export const people = [
  {
    username: "@ruru-m07",
    profileImg: "https://avatars.githubusercontent.com/u/142723369?v=4",
    description:
      "Tech lover with a passion for coding. Join me on this exciting journey of digital innovation. Let's build something amazing! #coding",
    joined: "August 20, 2023",
  },
  {
    username: "@mxkaske",
    profileImg:
